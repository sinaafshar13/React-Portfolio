...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm("service_f0ail6m", "template_idi7125", form.current, {
        publicKey: "bBW6DT4CI-8mIij0b",
      })
      .then(
        () => {
          console.log("SUCCESS!");
        ...
        <div className="contact-socials">
          ...
          <div className="social-boxs">
            <div className="social-box">
              ...
              <p className="social-address">afshari.sina@outlook.com</p>
              <p className="Social-button">
                Write me
                <i className="bx bx-right-arrow-alt social-button-icon"></i>
              </p>
            </div>
            <div className="social-box">
              <i className="bx bx-send social-box-icon"></i>
              <h3 className="social-name">Telegram</h3>
              <p className="social-address">@Cryptocoder19</p>
              <p className="Social-button">
                Write me
                <i className="bx bx-right-arrow-alt social-button-icon"></i>
              </p>
            ...
            <div className="social-box">
              <i className="bx bx-message-detail social-box-icon"></i>
              <h3 className="social-name">Message</h3>
              <p className="social-address">+98 - 921 - 527 - 4168</p>
              <p className="Social-button">
                Write me
                <i className="bx bx-right-arrow-alt social-button-icon"></i>
              </p>
